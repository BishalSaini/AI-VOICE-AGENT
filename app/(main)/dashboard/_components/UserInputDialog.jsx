...
function UserInputDialog({children, CoachingOptions}) { 
  ...
  const OnClickNext=async() => {  
    ...
    setIsLoading(false); 
    setOpenDialog(false); 
    router.push('/discussion-room/'+result); // Navigate to the discussion room
  }
            ...
            <DialogDescription asChild>
              <div className='mt-3'> 
                ...
                <h2 className='text-black mt-5'>
                  Select Your coaching expert {CoachingOptions.name}
                </h2>  
                  ...
                  {CoachingExpert.map((expert, index) => (
                    ...
                    >
                      <Image
                        ...
                        width={100}
                        height={100}
                        className={`rounded-2xl h-[80px] w-[80px] object-cover mx-auto mb-2
